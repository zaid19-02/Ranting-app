            ...
            <div class="row justify-content-center">
                <div class="col-xl-9 col-lg-10">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap">
                        <div>
                            <h2 class="fw-bold text-dark mb-1">Edit Data Anggota</h2>
                            <p class="text-muted small mb-0">Perbarui data profil anggota dengan informasi terbaru.</p>
                        </div>
                    ...
                    <form action="{{ route('anggotas.update', $anggota->id) }}" method="POST">
                        ...
                        <div class="card border-0 shadow-sm mb-5" style="border-radius: 16px; overflow: hidden;">
                            ...
                            <div style="height: 5px; background: linear-gradient(90deg, #ffc107, #fd7e14);"></div>
                            ...
                            <div class="card-body p-4 p-md-5">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="kode_wilayah"
                                            ...
                                            placeholder="Contoh: PGS-01"
                                            value="{{ old('kode_wilayah', $anggota->kode_wilayah) }}" required>
                                        @error('kode_wilayah')
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea name="alamat" class="form-control border-0 bg-light shadow-none" rows="2"
                                            placeholder="Jl. Raya No. 123..." required>{{ old('alamat', $anggota->alamat) }}</textarea>
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="ranting"
                                            ...
                                            value="{{ $anggota->ranting }}" required>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="status"
                                            ...
                                            <option value="GURU RANTING"
                                                {{ old('status', $anggota->status) == 'GURU RANTING' ? 'selected' : '' }}>
                                                GURU RANTING</option>
                                            <option value="ANGGOTA AKTIF"
                                                {{ old('status', $anggota->status) == 'ANGGOTA AKTIF' ? 'selected' : '' }}>
                                                ANGGOTA AKTIF</option>
                                            <option value="NON AKTIF"
                                                {{ old('status', $anggota->status) == 'NON AKTIF' ? 'selected' : '' }}>NON
                                                AKTIF</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="no_telpon"
                                                class="form-control form-control-lg border-0 bg-light shadow-none"
                                                value="{{ old('no_telpon', $anggota->no_telpon) }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-end mt-4 gap-2">
                                    <a href="{{ route('anggotas.index') }}"
                                        class="btn btn-light px-4 py-2 fw-semibold">Batal</a>
